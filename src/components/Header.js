...
import instagramLogo from '../assets/instagram-logo2.png'
import '../styles/home.css'

const Header = () => {

    return (
        <nav className="white home-nav">
            <div className='nav-wrapper container home-nav-container'>
                <img src={instagramLogo} className='brand-logo left home-nav-instagramlogo' alt="instagramLogo" />
                <a className='brand-logo center hide-on-small-only home-nav-search-container' href="#">
                    <form>
                        <div className='input-field'>
                            <input id='search' type='search' className="home-nav-search" required />
                            <label className='label-icon' htmlFor="search">
                                <i className="tiny home-nav-search-icon material-icons">search</i>
                            </label>
                            <i className="home-nav-close-icon material-icons">close</i>
                        </div>
                    </form>
                </a>
                <ul className="right">
